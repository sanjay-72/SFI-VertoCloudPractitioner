...
#define AIO_USERNAME    "AIO_USERNAME"            // Replace it with your username
...
Adafruit_MQTT_Subscribe Light1 = Adafruit_MQTT_Subscribe(&mqtt, AIO_USERNAME"/feeds/led01"); // FeedName
